...
const SearchContainer = ({ location, setLocation, filterParkLocation }) => {
  ...
  const [searchFocus, searchList, setSearchFocus, handleSearchList] = useSearch(address)
  ...
  return (
    <div className={cn('search-container', { seen })}>
      ...
      {searched && <AddressList searchList={searchList} setSearched={setSearched} setSearchFocus={setSearchFocus} handleSearchItem={handleSearchItem}></AddressList>}
